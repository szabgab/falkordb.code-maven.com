...
- The program should support `--load` for importing MovieLens CSV data, `--delete` for removing the `Movielens` graph, and `--report` for listing or running built-in dataset reports.
